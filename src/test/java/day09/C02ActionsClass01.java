...
// Verify the texts that appear after the buttons are operated.
    ...
    // Verify the texts that appear after the buttons are operated.
        Assert.assertTrue(driver.findElement(rightClickMessage).

    isDisplayed());
        Assert.assertTrue(driver.findElement(doubleClickMessage).

    isDisplayed());
        Assert.assertTrue(driver.findElement(dynamicClickMessage).
